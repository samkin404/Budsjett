...
function obBack(){showObStep(obStep-1)}

function obSaveIncome(){
  var v=parseInt(document.getElementById('ob-income-inp').value)||56000;
  obIncome=v;
  obNext();
}
...
function finishOb(){
  // Save income
  var d=gMD(cy,cm);d.income=obIncome;d.set=true;sMD(cy,cm,d);
